...
CASE WHEN Atingido > 70 THEN '#84f092' ELSE '#daebf5' END BKCOLOR, CAST(TotalCL as INT) Positivados
FROM (
...
SKU10.SKU SKU10, SKU3.SKU SKU3, CL.CL, TotalCL.TotalCL
...
GROUP BY VEN.CODVEND, PRO.MARCA, VEN.APELIDO, SKU10.SKU, SKU3.SKU, CL, TotalCL
